# Ubuntu 24.04 LTS (Noble) cloud image - rolling
#
# A full `apt dist-upgrade` runs inside the VM via cloud-init so the resulting
# image represents "freshly updated LTS" at the moment of build.
packer {
  required_plugins {
    qemu = {
