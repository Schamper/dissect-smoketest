# Fedora cloud image - rolling
#
# Pulls the latest dnf package set inside the VM via cloud-init so the resulting
# image represents "freshly updated Fedora" at the moment of build.
packer {
  required_plugins {
    qemu = {
...
variable "iso_checksum" {
  type    = string
  default = "file:https://download.fedoraproject.org/pub/fedora/linux/releases/44/Cloud/x86_64/images/Fedora-Cloud-44-1.7-x86_64-CHECKSUM"
}
